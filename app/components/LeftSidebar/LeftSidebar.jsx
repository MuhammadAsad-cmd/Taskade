...
const LeftSidebar = () => {
  return (
    <>
      <div className="flex">
        {/* left Sidebar */}
        <div className="relative hidden transition-all duration-300 ease-in-out lg:flex h-screen flex-shrink-0 w-[59px] flex-col overflow-auto border-r border-appcolor bg-dark-gray py-2 pb-0">
          <div className="flex items-center flex-col gap-y-4">
            <div className="flex flex-col items-center">
              <div className="flex  size-9 items-center justify-center p-0 shadow-none cursor-pointer border-0 relative rounded-xl text-light-gray transition-colors ease-in-out duration-200 bg-transparent hover:bg-appcolor">
                <SearchIcon />
              </div>
              <div className="flex  size-9 items-center justify-center p-0 shadow-none cursor-pointer border-0 relative rounded-xl text-light-gray transition-colors ease-in-out duration-200 bg-transparent hover:bg-appcolor">
                <ClockIcon />
            ...
            <div className="p-0.5  rounded-2xl border-2 border-white flex items-center justify-center">
              <div className="size-9 bg-vivid-pink rounded-xl flex items-center justify-center text-white font-medium text-lg">
                W
              </div>
            </div>
          </div>
          <div className="sticky bottom-0 z-10 mt-auto flex w-full flex-col items-center gap-y-px bg-appcolor-100/95 py-3 dark:bg-appcolor-0/95">
            <button className="relative flex size-9 cursor-pointer items-center justify-center rounded-xl text-light-gray shadow-none transition-colors duration-200 ease-in-out hover:bg-appcolor">
              <svg
                fill="currentColor"
                height="20"
                width="20"
            ...
            <button
              ...
              role="button"
              tabindex="0"
              className="relative flex size-9 cursor-pointer items-center justify-center rounded-xl text-light-gray shadow-none transition-colors duration-200 ease-in-out hover:bg-appcolor"
            >
              <svg
                fill="currentColor"
                height="20"
        ...
        <div className="w-[250px] transition-all duration-300 hidden lg:flex shrink-0 flex-col border-r border-appcolor bg-dark-gray duration-250 ease-in-out">
          <div className="h-full overflow-y-auto p-3 no-scrollbar">
            <div className="rounded-md">
              <div className="relative mb-px flex cursor-pointer items-center gap-3 rounded-lg px-3 py-1 text-sm text-appcolor-800 hover:bg-appcolor  bg-appcolor ">
            ...
            <button
              type="button"
              className="relative flex w-full cursor-pointer items-center gap-3 rounded-lg px-3 py-1 text-sm text-appcolor-800 hover:bg-appcolor"
            >
          ...
          <div className="shadow:md p-4 m-2 mb-3 flex flex-col gap-y-4 rounded-xl border border-solid border-appcolor bg-[#1b1f22]">
            <h2 className="text-md flex items-center gap-x-2 font-medium text-appcolor-1000">
              🎉 Try Pro!
            </h2>
            <p className="pb-2 text-sm text-[#c7c3b8]">
